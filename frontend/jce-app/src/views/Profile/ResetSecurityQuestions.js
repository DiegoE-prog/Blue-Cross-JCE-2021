            ...
            <form onSubmit={updateSecurityQuestionsInfo}>
              ...
              <div className="squestion">
                ...
                <div className="col-12">
                  ...
                  <input className="general-jce" id="q2Answer" name="q2Answer" type="text" value={securityQuestions.q2Answer} onChange={handleQuestionsChange}/>
                </div>

                <div className="col-12">
                  <h5 className="general-jce">What is the name of the city where you grew up?</h5>
                  <input className="general-jce" id="q3Answer" name="q3Answer" type="text" value={securityQuestions.q3Answer} onChange={handleQuestionsChange}/>
                </div>

                <div className="col-12">
                  <h5 className="general-jce">What brand was your first car?</h5>
                  <input className="general-jce" id="q4Answer" name="q4Answer" type="text" value={securityQuestions.q4Answer} onChange={handleQuestionsChange}/>
                </div>

                <div className="col-12">
                  <h5 className="general-jce">What is the name of your University?</h5>
                  <input className="general-jce" id="q5Answer" name="q5Answer" type="text" value={securityQuestions.q5Answer} onChange={handleQuestionsChange}/>
                </div>

                <div className="col-12">
                  <h5 className="general-jce">What is your favorite Sport?</h5>
                  <input className="general-jce" id="q6Answer" name="q6Answer" type="text" value={securityQuestions.q6Answer} onChange={handleQuestionsChange}/>
                </div>

                <div className="col-12">
                  <h5 className="general-jce">What is the name of your first boss?</h5>
                  <input className="general-jce" id="q7Answer" name="q7Answer" type="text" value={securityQuestions.q7Answer} onChange={handleQuestionsChange}/>
                </div>

                <div className="col-12">
                  <h5 className="general-jce">What is your favorite band?</h5>
                  <input className="general-jce" id="q8Answer" name="q8Answer" type="text" value={securityQuestions.q8Answer} onChange={handleQuestionsChange}/>
                </div>
              </div>
              <br />
              <div className="col-12">
                ...
                &nbsp;
                <Link className="btn btn-blue mt-2" to={routes.RESETPASSSQ}>
                  Next
							  </Link>
