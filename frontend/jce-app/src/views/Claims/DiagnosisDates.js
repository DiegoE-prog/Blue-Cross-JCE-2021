...
function DiagnosisDates({ diagnosisDates, setDiagnosisDates }) {
  ...
  const [authorizedReturnWorkError, setAuthorizedReturnWorkError] =
    useState("");
        ...
        <div className="row">
          ...
          <div className="col-2">
            <input
              ...
              name="onsetOfSymptom"
              id="onsetOfSymptom"
              value={diagnosisDates.onsetOfSymptom}
              onChange={handleChange}
              onKeyUp={(event) => dateFormatValidation(event, "onsetOfSymptom")}
              maxLength="10"
              type="date"
            ></input>
          </div>
        ...
        <div className="row">
          ...
          <div className="col-2">
            <input
              ...
              id="initialTreatment"
              value={diagnosisDates.initialTreatment}
              onChange={handleChange}
              onKeyUp={(event) =>
                dateFormatValidation(event, "initialTreatment")
              }
              maxLength="10"
              type="date"
            ></input>
        ...
        <div className="row">
          ...
          <div className="col-2">
            <input
              ...
              name="lastSentDate"
              id="lastSentDate"
              value={diagnosisDates.lastSentDate}
              onChange={handleChange}
              onKeyUp={(event) => dateFormatValidation(event, "lastSentDate")}
              maxLength="10"
            ></input>
          </div>
          <div className="col-2">
        ...
        <div className="row">
          ...
          <div className="col-2">
            <input
              type="date"
              className="w-100"
              name="acuteManifestation"
              id="acuteManifestation"
              value={diagnosisDates.acuteManifestation}
              onChange={handleChange}
              onKeyUp={(event) =>
                dateFormatValidation(event, "acuteManifestation")
              }
              maxLength="10"
            ></input>
          </div>
        ...
        <div className="row">
          ...
          <div className="col-2">
            <input
              ...
              name="accident"
              id="accident"
              value={diagnosisDates.accident}
              onChange={handleChange}
              onKeyUp={(event) => dateFormatValidation(event, "accident")}
              maxLength="10"
            ></input>
          </div>
          <div className="col-2">
        ...
        <div className="row">
          ...
          <div className="col-2">
            <input
              ...
              value={diagnosisDates.lastMenstrualDate}
              onChange={handleChange}
              onKeyUp={(event) =>
                dateFormatValidation(event, "lastMenstrualDate")
              }
              maxLength="10"
            ></input>
          </div>
        ...
        <div className="row">
          ...
          <div className="col-2">
            <input
              ...
              name="lastXRay"
              id="lastXRay"
              value={diagnosisDates.lastXRay}
              onChange={handleChange}
              onKeyUp={(event) => dateFormatValidation(event, "lastXRay")}
              maxLength="10"
            ></input>
          </div>
          <div className="col-2">
        ...
        <div className="row">
          ...
          <div className="col-2">
            <input
              type="date"
              className="w-100"
              name="hearingVisionPresc"
              id="hearingVisionPresc"
              value={diagnosisDates.hearingVisionPresc}
              onChange={handleChange}
              onKeyUp={(event) =>
                dateFormatValidation(event, "hearingVisionPresc")
              }
              maxLength="10"
            ></input>
          </div>
        ...
        <div className="row">
          ...
          <div className="col-2">
            <input
              ...
              id="disabilityDates"
              value={diagnosisDates.disabilityDates}
              onChange={handleChange}
              onKeyUp={(event) =>
                dateFormatValidation(event, "disabilityDates")
              }
              maxLength="10"
            ></input>
          </div>
        ...
        <div className="row">
          ...
          <div className="col-2">
            <input
              ...
              name="lastWorked"
              id="lastWorked"
              value={diagnosisDates.lastWorked}
              onChange={handleChange}
              onKeyUp={(event) => dateFormatValidation(event, "lastWorked")}
              maxLength="10"
            ></input>
          </div>
          <div className="col-2">
        ...
        <div className="row">
          ...
          <div className="col-2">
            <input
              type="date"
              className="w-100"
              name="authorizedReturnWork"
              id="authorizedReturnWork"
              value={diagnosisDates.authorizedReturnWork}
              onChange={handleChange}
              onKeyUp={(event) =>
                dateFormatValidation(event, "authorizedReturnWork")
              }
              maxLength="10"
            ></input>
          </div>
        ...
        <div className="row">
          ...
          <div className="col-2">
            <input
              ...
              name="assumedRelinq"
              id="assumedRelinq"
              value={diagnosisDates.assumedRelinq}
              onChange={handleChange}
              onKeyUp={(event) => dateFormatValidation(event, "assumedRelinq")}
              maxLength="10"
            ></input>
          </div>
          <div className="col-2">
        ...
        <div className="row">
          ...
          <div className="col-2">
            <input
              type="date"
              className="w-100"
              name="repricerReceived"
              id="repricerReceived"
              value={diagnosisDates.repricerReceived}
              onChange={handleChange}
              onKeyUp={(event) =>
                dateFormatValidation(event, "repricerReceived")
              }
              maxLength="10"
            ></input>
          </div>
